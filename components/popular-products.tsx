...
export default function PopularProducts() {
  ...
  useEffect(() => {
    const API_URL = "https://pichpisey-store.oneforthecode.xyz/api/products?populate=*";
      ...
      try {
        ...
        const data = json.data.map((product: any) => {
          ...
          return {
            ...
            image: image ? `https://pichpisey-store.oneforthecode.xyz${image}` : '/default-image.png',
